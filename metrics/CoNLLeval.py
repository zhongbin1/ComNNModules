...
class CoNLLeval:
    """Cf. https://github.com/AdolfVonKleist/rnn-slu/blob/master/rnnslu/CoNLLeval.py
    Evaluate the result of processing CoNLL-2000 shared tasks.
    This is a vanilla python port of the original perl script.
    ...
    def evaluate(self, infile):
        ...
        """
        with codecs.open(infile, mode="r", encoding="utf-8") as ifp:
            for line in ifp:
    ...
    def conlleval(self, predictions, groundtruth, words, infile):
        ...
        Returns:
            ...
            infile: The inputs written to file in the format understood by the conlleval.pl script and CoNLLeval python
                    port.
        """
        ofp = codecs.open(infile, mode="w", encoding="utf-8", errors="ignore")
...
if __name__ == "__main__":
    ...
    ce = CoNLLeval(verbose=args.verbose,
                   raw=args.raw,
